...
type TokenResponse struct {
	...
	AccessToken  string `protobuf:"bytes,1,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"`    // short-lived token (was JWT)
	RefreshToken string `protobuf:"bytes,2,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"` // long-lived token
}
...
var file_io_defang_v1_fabric_proto_rawDesc = []byte{
	...
	0x67, 0x73, 0x22, 0xf4, 0x01, 0x0a, 0x0a, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e,
	...
	0x6e, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x50, 0x0a, 0x14, 0x50, 0x75, 0x74,
	...
	0x52, 0x4f, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x54, 0x45, 0x41, 0x4d, 0x10, 0x04, 0x32, 0xfe,
	0x17, 0x0a, 0x10, 0x46, 0x61, 0x62, 0x72, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x90, 0x02, 0x01, 0x12, 0x43, 0x0a, 0x06,
...
var file_io_defang_v1_fabric_proto_depIdxs = []int32{
	...
	51, // 93: io.defang.v1.FabricController.GetStatus:output_type -> io.defang.v1.Status
	52, // 94: io.defang.v1.FabricController.GetVersion:output_type -> io.defang.v1.Version
	50, // 95: io.defang.v1.FabricController.Token:output_type -> io.defang.v1.TokenResponse
	83, // 96: io.defang.v1.FabricController.RevokeToken:output_type -> google.protobuf.Empty
	55, // 97: io.defang.v1.FabricController.Tail:output_type -> io.defang.v1.TailResponse
	34, // 98: io.defang.v1.FabricController.Update:output_type -> io.defang.v1.ServiceInfo
	24, // 99: io.defang.v1.FabricController.Deploy:output_type -> io.defang.v1.DeployResponse
	34, // 100: io.defang.v1.FabricController.Get:output_type -> io.defang.v1.ServiceInfo
	26, // 101: io.defang.v1.FabricController.Delete:output_type -> io.defang.v1.DeleteResponse
	15, // 102: io.defang.v1.FabricController.Destroy:output_type -> io.defang.v1.DestroyResponse
	83, // 103: io.defang.v1.FabricController.Publish:output_type -> google.protobuf.Empty
	74, // 104: io.defang.v1.FabricController.Subscribe:output_type -> io.defang.v1.SubscribeResponse
	56, // 105: io.defang.v1.FabricController.GetServices:output_type -> io.defang.v1.GetServicesResponse
	29, // 106: io.defang.v1.FabricController.GenerateFiles:output_type -> io.defang.v1.GenerateFilesResponse
	30, // 107: io.defang.v1.FabricController.StartGenerate:output_type -> io.defang.v1.StartGenerateResponse
	29, // 108: io.defang.v1.FabricController.GenerateStatus:output_type -> io.defang.v1.GenerateFilesResponse
	17, // 109: io.defang.v1.FabricController.Debug:output_type -> io.defang.v1.DebugResponse
	...
	35, // 114: io.defang.v1.FabricController.ListSecrets:output_type -> io.defang.v1.Secrets
	41, // 115: io.defang.v1.FabricController.GetConfigs:output_type -> io.defang.v1.GetConfigsResponse
	...
	44, // 118: io.defang.v1.FabricController.ListConfigs:output_type -> io.defang.v1.ListConfigsResponse
	83, // 119: io.defang.v1.FabricController.PutDeployment:output_type -> google.protobuf.Empty
	48, // 120: io.defang.v1.FabricController.ListDeployments:output_type -> io.defang.v1.ListDeploymentsResponse
	33, // 121: io.defang.v1.FabricController.CreateUploadURL:output_type -> io.defang.v1.UploadURLResponse
	77, // 122: io.defang.v1.FabricController.DelegateSubdomainZone:output_type -> io.defang.v1.DelegateSubdomainZoneResponse
	83, // 123: io.defang.v1.FabricController.DeleteSubdomainZone:output_type -> google.protobuf.Empty
	77, // 124: io.defang.v1.FabricController.GetDelegateSubdomainZone:output_type -> io.defang.v1.DelegateSubdomainZoneResponse
	78, // 125: io.defang.v1.FabricController.WhoAmI:output_type -> io.defang.v1.WhoAmIResponse
	...
	11, // 129: io.defang.v1.FabricController.GetSelectedProvider:output_type -> io.defang.v1.GetSelectedProviderResponse
	83, // 130: io.defang.v1.FabricController.SetSelectedProvider:output_type -> google.protobuf.Empty
	22, // 131: io.defang.v1.FabricController.CanIUse:output_type -> io.defang.v1.CanIUseResponse
