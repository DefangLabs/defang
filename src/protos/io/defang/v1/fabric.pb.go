...
const (
	Behavior_UNSPECIFIED_BEHAVIOR Behavior = 0
	Behavior_DEVELOPMENT          Behavior = 1
	Behavior_STAGING              Behavior = 2
	Behavior_PRODUCTION           Behavior = 3
)

// Enum value maps for Behavior.
var (
	Behavior_name = map[int32]string{
		0: "UNSPECIFIED_BEHAVIOR",
		1: "DEVELOPMENT",
		2: "STAGING",
		3: "PRODUCTION",
	}
	Behavior_value = map[string]int32{
		"UNSPECIFIED_BEHAVIOR": 0,
		"DEVELOPMENT":          1,
		"STAGING":              2,
		"PRODUCTION":           3,
	}
...
type DeployRequest struct {
	...
	Behavior Behavior   `protobuf:"varint,3,opt,name=behavior,proto3,enum=io.defang.v1.Behavior" json:"behavior,omitempty"`
}
...
func (x *DeployRequest) GetBehavior() Behavior {
	if x != nil {
		return x.Behavior
	}
	return Behavior_UNSPECIFIED_BEHAVIOR
}
...
type ProjectUpdate struct {
	...
	Project  string         `protobuf:"bytes,3,opt,name=project,proto3" json:"project,omitempty"`
	Behavior Behavior       `protobuf:"varint,4,opt,name=behavior,proto3,enum=io.defang.v1.Behavior" json:"behavior,omitempty"`
}
...
func (x *ProjectUpdate) GetBehavior() Behavior {
	if x != nil {
		return x.Behavior
	}
	return Behavior_UNSPECIFIED_BEHAVIOR
...
var file_io_defang_v1_fabric_proto_rawDesc = []byte{
	...
	0x16, 0x2e, 0x69, 0x6f, 0x2e, 0x64, 0x65, 0x66, 0x61, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x42,
	0x65, 0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x52, 0x08, 0x62, 0x65, 0x68, 0x61, 0x76, 0x69, 0x6f,
	0x72, 0x22, 0x5b, 0x0a, 0x0e, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_io_defang_v1_fabric_proto_goTypes = []any{
	(Behavior)(0),                         // 0: io.defang.v1.Behavior
