...
func (DefaultToolCLI) ConfigSet(ctx context.Context, isSecret bool, projectName string, provider cliClient.Provider, name, value string) error {
	return cli.ConfigSet(ctx, isSecret, projectName, provider, name, value)
}
