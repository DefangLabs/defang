	...
	tools := []server.ServerTool{
		...
		},
		{
			Tool: mcp.NewTool("set_config",
				mcp.WithDescription("Set a config variable from the defang project"),
				workingDirectoryOption,
				multipleComposeFilesOptions,
				mcp.WithBoolean("insensitive",
					mcp.Description("The config is insensitive (not secret). Defaults to false."),
