...
func HandleListConfigTool(ctx context.Context, loader cliClient.Loader, params ListConfigParams, cli CLIInterface, ec elicitations.Controller, sc StackConfig) (string, error) {
