...
func HandleRemoveConfigTool(ctx context.Context, loader cliClient.Loader, params RemoveConfigParams, cli CLIInterface, ec elicitations.Controller, sc StackConfig) (string, error) {
