...
//
// 	nsServers, delegationSetId, err := prepareDomainDelegation(ctx, projectDomain, "projectname", "stack", r53Client)
// 	if err != nil {
// 		t.Fatal(err)
// 	}
// 	if len(nsServers) == 0 {
...
// 		nsServers2, delegationSetId2, err := prepareDomainDelegation(ctx, projectDomain, "projectname", "stack", r53Client)
// 		if err != nil {
// 			t.Fatal(err)
// 		}
