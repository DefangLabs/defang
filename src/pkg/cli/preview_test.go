...
func TestPreviewStops(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := Preview(t.Context(), project, fabric, provider, ComposeUpParams{Mode: modes.RecipeUnspecified, Project: project})
			if err != nil {
	...
	t.Run("Context cancellation", func(t *testing.T) {
		...
		err := Preview(ctx, project, fabric, provider, ComposeUpParams{Mode: modes.RecipeUnspecified, Project: project})
		if err != nil {
