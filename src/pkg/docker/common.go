...
func (Docker) GetConfig(ctx context.Context, rootPath string, names ...string) (*defangv1.ConfigValues, error) {
	return nil, errors.New("docker does not support secrets")
}

func (Docker) DeleteConfig(ctx context.Context, rootPath string, name ...string) error {
	return errors.New("docker does not support secrets")
}
