This template is a simple static "Hello World" project developed using Django. It is ready to be deployed by Defang, and you could make your project available to the world in just 5 minutes!
